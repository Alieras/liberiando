...
class _CrearCuentaWidgetState extends State<CrearCuentaWidget>
  ...
  void initState() {
    ...
    _model.adminTokenTextController ??= TextEditingController();
    _model.adminTokenFocusNode ??= FocusNode();
                      ...
                      children: [
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              if (selectedMedia != null &&
                                ...
                                safeSetState(() => _model
                                    .isDataUploading_uploadDataYyd = true);
                                ...
                                try {
                                  ...
                                  _model.isDataUploading_uploadDataYyd = false;
                                }
                        ...
                        Padding(
                          ...
                          child: Container(
                            width: double.infinity,
                            child: TextFormField(
                              controller: _model.adminTokenTextController,
                              focusNode: _model.adminTokenFocusNode,
                              autofocus: true,
                              autofillHints: [AutofillHints.email],
                              obscureText: false,
                              decoration: InputDecoration(
                              ...
                              keyboardType: TextInputType.emailAddress,
                              validator: _model
                                  .adminTokenTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ),
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              FFAppState().varRol =
                                  _model.adminTokenTextController.text ==
                                          '789545'
                                      ? 'Administrador'
                                      : 'Usuario';
                              safeSetState(() {});
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                if (_model.nombreTextController.text.isEmpty) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        'Email required!',
                                ...
                                await authManager.resetPassword(
                                  email: _model.nombreTextController.text,
                                  context: context,
                                );
                              },
