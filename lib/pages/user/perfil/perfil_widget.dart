                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    FFAppState().varImagen = currentUserPhoto;
                                    safeSetState(() {});
                                ...
                                children: [
                                  StreamBuilder<List<AsistenciasRecord>>(
                                    stream: queryAsistenciasRecord(
                                      queryBuilder: (asistenciasRecord) =>
                                          asistenciasRecord.where(
                                        'usuarioRef',
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemCount: listViewAsistenciasRecordList
                                            .length,
